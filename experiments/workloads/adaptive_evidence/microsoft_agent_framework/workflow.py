...
@workflow
async def adaptive_evidence(payload: dict) -> dict:
...
async def run(args) -> dict:
    instance = adaptive_evidence.build()
    result = await instance.run({"scenario_id": args.scenario, "output": args.output, "max_rounds": args.max_rounds})
